...
describe('IOD-HTTP-Factory Test ', function () {
  ...
  beforeEach(module(function ($provide) {
    ...
    //iodEnvConfigServiceMock = jasmine.createSpy('iodEnvConfigService',[]);
    //iodEnvConfigServiceMock.getIodHost = jasmine.createSpy('getIodHost').and.returnValue('mock_host_name');
    //$provide.value('iodEnvConfigService',iodEnvConfigServiceMock)
  }));
